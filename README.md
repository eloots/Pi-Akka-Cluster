...
- docs folder contains all documentation with images
- led - is folder with LED exercises
- scripts has all scripts that will be useful when working with multi node cluster
...
- A schematic of the LED strip can be found [here](docs/images/Schema_LED_Strip.pdf)
