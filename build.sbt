...
lazy val pi_cluster_master = (project in file("."))
  .aggregate(
    ...
    exercise_004_cluster_cluster_singleton,
    ...
    exercise_011_split_brain_resolver_static_quorum_http_mamagement,
    exercise_012_clustered_sudoku_solver,
    exercise_013_add_cluster_client,
    exercise_014_clustered_sudoku_solver_cluster_client_enabled,
    exercise_015_es_vizceral,
    exercise_016_es_opentracing,
    exercise_017_es_classic_console,
...
lazy val exercise_004_cluster_cluster_singleton = project
  .configure(CommonSettings.configure)
  .dependsOn(common % "test->test;compile->compile")
...
lazy val exercise_011_split_brain_resolver_static_quorum_http_mamagement = project
  .configure(CommonSettings.configure)
  .dependsOn(common % "test->test;compile->compile")
...
lazy val exercise_013_add_cluster_client = project
  .configure(CommonSettings.configure)
  .dependsOn(common % "test->test;compile->compile")

lazy val exercise_014_clustered_sudoku_solver_cluster_client_enabled = project
  .configure(CommonSettings.configure)
  .dependsOn(common % "test->test;compile->compile")

lazy val exercise_015_es_vizceral = project
  .configure(CommonSettings.configure)
  .dependsOn(common % "test->test;compile->compile")

lazy val exercise_016_es_opentracing = project
  .configure(CommonSettings.configure)
  .dependsOn(common % "test->test;compile->compile")

lazy val exercise_017_es_classic_console = project
  .configure(CommonSettings.configure)
  .dependsOn(common % "test->test;compile->compile")
